  ...
  return (
    <>
      ...
      <div className="profile-info flex flex-col items-center relative bottom-20 gap-y-5">
        ...
        <div className="ussername text-2xl font-bold">John Doe</div>
      </div>
      <div className="socialbar flex bg-black w-64 h-10 rounded-3xl justify-center items-center gap-8 mx-auto">
        <a id="github" href="#">
          <svg
            viewBox="0 0 16 16"
            fill="white"
